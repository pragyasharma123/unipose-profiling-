...
class Trainer(object):
    def __init__(self, args):
        ...
        self.model = unipose(self.dataset, num_classes=self.numClasses,backbone='resnet',output_stride=16,sync_bn=True,freeze_bn=False, stride=self.stride).cuda()
    ...
    def test(self,epoch):
        model_weights_path = "/home/ps332/myViT/UniPose/UniPose_MPII.pth"
...
parser.add_argument('--test_dir', type=str, dest='test_dir', default='/PATH/TO/LSP/VAL')
